...
namespace Visuality
{
    public partial class EditHeadArea : BaseDialog
    {
        ...
        private RelativeRectModel _relativeRect = new(PowerAim.Types.RelativeRect.Default);
        ...
        public EditHeadArea(string relativeRect, Action<RelativeRectModel> onSave = null) : this(PowerAim.Types.RelativeRect.ParseOrDefault(relativeRect), onSave)
        {}
        ...
        {
            RelativeRect = new RelativeRectModel(PowerAim.Types.RelativeRect.Default);
        }
    }
